...
create table \`user\`(
    ...
    \`organization_id\` bigint unsigned NOT NULL DEFAULT 0 COMMENT '所属组织',
    \`nickname\` varchar(64) COMMENT '昵称',
    \`realname\` varchar(64) COMMENT '真名',
    \`avatar\` varchar(128) COMMENT '头像',
    \`user_type\` int unsigned NOT NULL DEFAULT 3 COMMENT '用户类型1:super admin,2:admin,3:user',
...
create table \`user_login\`(
    \`id\` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
    \`user_id\` bigint unsigned NOT NULL COMMENT '用户ID',
    \`ip\` bigint unsigned NOT NULL COMMENT '登录IP',
    \`device_id\` varchar(128) NOT NULL COMMENT '设备ID',
    \`platform\` int unsigned NOT NULL COMMENT '平台',
    \`login_type\` int unsigned NOT NULL COMMENT '登录类型',
...
create table \`team\`(
    ...
    \`leader\` bigint unsigned NOT NULL COMMENT '队长',
    \`organization_id\` bigint unsigned NOT NULL DEFAULT 0 COMMENT '所属组织',
    \`avatar\` varchar(128) COMMENT '头像',
    \`status\` int NOT NULL COMMENT '状态',
    \`update_time\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
create table \`organization\`(
    ...
    \`owner\` bigint unsigned NOT NULL COMMENT '组织所有人',
    \`parent_id\` bigint unsigned NOT NULL DEFAULT 0 COMMENT '父组织',
    \`avatar\` varchar(128) COMMENT '头像',
    \`status\` int NOT NULL COMMENT '状态',
    \`update_time\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    \`create_time\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE \`problem_base\` (
    ...
    \`writer_id\` BIGINT UNSIGNED NOT NULL COMMENT '出题人ID',
    \`properties\` VARCHAR(1024) DEFAULT NULL COMMENT '针对不同题目类型的描述JSON',
    \`show_id\` VARCHAR(16) NOT NULL COMMENT '展示的题号',
    \`source_id\` BIGINT UNSIGNED NOT NULL COMMENT '题目来源',
    \`submission_count\` BIGINT UNSIGNED DEFAULT 0 COMMENT '提交数',
    \`accepted_count\` BIGINT UNSIGNED DEFAULT 0 COMMENT '通过数',
...
CREATE TABLE \`problem_content\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '题目内容ID',
...
CREATE TABLE \`contest_base\`(
    ...
    \`organization_id\` BIGINT UNSIGNED NOT NULL COMMENT '承办组织',
...
CREATE TABLE \`contest_content\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '比赛内容ID',
...
CREATE TABLE \`register\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID',
    \`contest_id\` BIGINT UNSIGNED NOT NULL COMMENT '比赛ID',
    \`registrant_id\` BIGINT UNSIGNED NOT NULL COMMENT '注册人ID',
    \`registrant_type\` INT UNSIGNED NOT NULL COMMENT '注册人类型',
    \`team_id\` BIGINT UNSIGNED COMMENT '队伍ID',
...
CREATE TABLE \`contest_problem\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '赛题ID',
    \`contest_id\` BIGINT UNSIGNED NOT NULL COMMENT '比赛ID',
    \`problem_id\` BIGINT UNSIGNED NOT NULL COMMENT '题目ID',
    \`submission_count\` BIGINT UNSIGNED NOT NULL COMMENT '提交数',
    \`accepted_count\` BIGINT UNSIGNED NOT NULL COMMENT 'AC数',
...
CREATE TABLE \`submission_base\`(
    ...
    \`submitter_type\` INT UNSIGNED NOT NULL COMMENT '提交者类型（团队或个人）',
    \`status\` INT NOT NULL COMMENT '提交结果',
    \`type\` INT NOT NULL COMMENT '提交类型',
    \`contest_id\` BIGINT UNSIGNED COMMENT '关联的比赛',
    \`problem_id\` BIGINT UNSIGNED COMMENT '关联的题目',
...
CREATE TABLE \`submission_content\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '提交内容ID',
...
CREATE TABLE \`solution_base\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '题解ID',
    \`writer_id\` BIGINT UNSIGNED NOT NULL COMMENT '作者ID',
    \`contest_id\` BIGINT UNSIGNED COMMENT '关联的比赛',
    \`problem_id\` BIGINT UNSIGNED COMMENT '关联的题目',
    \`status\` INT NOT NULL COMMENT '状态枚举',
    \`update_time\` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE \`solution_content\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '题解内容ID',
...
CREATE TABLE \`problemset\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '题单ID',
...
CREATE TABLE \`problemset_problem\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '题单-题目ID',
    \`problemset_id\` BIGINT UNSIGNED NOT NULL COMMENT '题单ID',
    \`problem_id\` BIGINT UNSIGNED NOT NULL COMMENT '题目ID',
...
CREATE TABLE \`object_tag\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主体-标签ID',
    \`target_id\` BIGINT UNSIGNED NOT NULL COMMENT '主体ID',
    \`target_type\` INT NOT NULL COMMENT '目标主体类型',
...
CREATE TABLE \`score\`(
    \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ScoreID',
    \`name\` VARCHAR(32) NOT NULL COMMENT 'Score名称',
    \`target_type\` INT NOT NULL COMMENT '目标主体类型',
    \`target_id\` BIGINT UNSIGNED NOT NULL COMMENT '目标主体ID',
    \`agg_id\` BIGINT UNSIGNED NOT NULL COMMENT '聚合基准',
    \`value\` BIGINT UNSIGNED NOT NULL COMMENT '得分',
    \`status\` INT NOT NULL COMMENT '状态枚举',
